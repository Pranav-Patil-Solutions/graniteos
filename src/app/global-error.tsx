...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    console.error("[GraniteOS] Critical root error:", error);
  }, [error]);
  ...
  return (
    <html lang="en">
      <body
        style={{ margin: 0 }}
        className="min-h-screen bg-[#0b0e11] flex items-center justify-center p-6 font-sans antialiased"
      >
        <div className="max-w-md w-full rounded-2xl border border-white/10 bg-white/[0.04] p-8 text-center shadow-2xl">
          ...
          <h1 className="text-xl font-semibold text-white mb-2">
            GraniteOS encountered a problem
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            {/* The root layout (and its router context) failed — a hard <a>
                reload is the only reliable way home from a global error. */}
